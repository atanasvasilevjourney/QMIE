...
- **Desk tabs:** Landing is **ORBIT** (Orbis Universe 3D). **OPS** holds Trend Radar plus separate tables for TEMA scanner vs daily breakout. Do not put the 3D universe back on OPS. Row **DETAILS** expands stored alert/radar fields; it is not a historical HL replay (a 67–68k BTC higher-low only appears if that closed bar actually graded A/A+).
