...
const STEPS = [
  ...
  },
  {
    ...
    body: 'RGG + coils + breakouts are unranked daily context — not entries.',
  },
  {
    title: 'Wait for A/A+ alert',
    body: 'Live Signals / Discord carry the graded setups. Open the TradingView deep-link.',
  },
  {
  ...
  return (
    <PanelShell title="Operator Flows" subtitle="best-path manual trading loop · no broker">
      ...
      <div className="mt-5 grid gap-3 md:grid-cols-3">
        <Tip title="Radar ≠ Grade" body="Fresh GREEN is a watchlist cue. Trade only after ranked A/A+." />
        <Tip title="4H edge" body="OOS A/A+ was strongest on 4H — prefer that TF for size." />
